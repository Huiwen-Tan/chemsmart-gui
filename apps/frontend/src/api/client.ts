...
export function checkMoleculeSourceStatus(
  payload: MoleculeSourceStatusRequest,
): Promise<MoleculeSourceStatusResponse> {
  return request('/api/documents/source-status', {
    method: 'POST',
    body: JSON.stringify(payload),
  });
}
